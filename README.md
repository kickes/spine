...
Next, open `test/index.html` to run the [Jasmine](https://github.com/jasmine/jasmine) test suite for spine core.  If you see all the tests passing, you're ready to contribute!
